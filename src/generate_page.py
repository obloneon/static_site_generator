    ...
    for content in contents:
        ...
        if os.path.isfile(content_path):
            if content_path.endswith(".md"):
                generate_page(base_path, content_path, template_path, content_dest_dir_path)
            else:
                continue
        else:
            generate_pages_recursive(base_path, content_path, template_path, content_dest_dir_path)