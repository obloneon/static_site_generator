import unittest
from inline_markdown_transform import (
...
class TestInlineMarkdown(unittest.TestCase):
    def test_delim_bold(self):
        ...
        new_nodes = split_nodes_at_delimiter([node], "**", TextType.BOLD)
    ...
    def test_delim_italic(self):
        ...
        new_nodes = split_nodes_at_delimiter([node], "_", TextType.ITALIC)
        self.assertListEqual(
            [
    ...
    def test_delim_code(self):
        ...
        new_nodes = split_nodes_at_delimiter([node], "`", TextType.CODE)
        self.assertListEqual(
            [
                TextNode("This is text with a ", TextType.TEXT),
